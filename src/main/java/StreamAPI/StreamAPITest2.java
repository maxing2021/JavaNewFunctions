...
//          练习：是否所有的员工的年龄都大于18
        ...
        System.out.println("是否所有的员工的年龄都大于18" + allMatch);

//        anyMatch(Predicate p)——检查是否至少匹配一个元素。
//         练习：是否存在员工的工资大于 10000
        boolean anyMatch = employees.stream().anyMatch(e -> e.getSalary() > 10000);
        System.out.println("是否存在员工的工资大于 10000" + anyMatch);
...
//        findAny——返回当前流中的任意元素
        ...
        System.out.println("任意元素" + employee1);
    ...
    public void test2(){
        ...
        System.out.println("流中元素的总个数:" + count);
...
//        练习：返回最低工资的员工
        ...
        System.out.println("返回最低工资的员工:" +employee);
        System.out.println();
